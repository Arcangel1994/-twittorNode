...
var swLocation = '/-twittorNode/sw.js';
...
function crearMensajeHTML(mensaje, personaje, lat, lng, foto) {
    ...
    // Borramos la latitud y longitud por si las usÃ³
    lat = null;
    lng = null;
...
function isOnline(){
    ...
    if(navigator.onLine){
        ...
        var myToast = mdtoast('Tienes internet', { duration: 2000, init: true }); 
        myToast.show();
    }else{
...
// Obtener la geolocalizaciÃ³n
btnLocation.on('click', () => {

    //console.log('Boton geolocalizacion');
...
timeline.on('click', 'li', function(){
    ...
    if(tipo === 'mapa'){
        shareOpts.text = 'Mapa'
        shareOpts.url = `https://www.google.com/maps/@${lat},${lng},16z`
    }
